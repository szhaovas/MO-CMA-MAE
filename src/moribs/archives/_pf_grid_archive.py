...
class PFGridArchive(GridArchive):
    """Similar to GridArchive, except each archive cell contains a Pareto Front,
    ...
    Args:
        ...
        Other params are the same as their counterparts in GridArchive. The current
        version of PFGridArchive does not implement annealing, and assumes the objective
    ...
    def __init__(
        ...
        *,
        ...
        GridArchive.__init__(
            self, solution_dim=solution_dim, dims=dims, ranges=ranges, seed=seed
        )

        """Compared to GridArchive, ArrayStore object replaces the fields
        ...
        Returns:
            ...
            - ``"status"`` (:class:`numpy.ndarray` of :class:`int`): An array of
              ...
              - ``0``: The solution's UHVI value, after clipped by ``hvi_cutoff_threshold``,
                ...
                to the "not added" case from GridArchive.add().
              ...
              - ``2``: The current Pareto Front within the archive cell is empty.
                This corresponds to the "new cell" case from GridArchive.add().
    ...
    def sample_elites(self, n):
        ...
        When ``self._bias_sampling=True``, nn solutions are sampled by first uniformly
