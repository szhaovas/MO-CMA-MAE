...
with sns.axes_style("white"):
    ...
    plt.ylabel("MOQD-Score")
    # plt.ylabel("Largest HV")
    # plt.ylabel("Coverage")

    if have_legend:
        legend = plt.legend(loc="lower right", bbox_to_anchor=(1,1,0.5,0.5), frameon=False, prop={"size": 45})
    ...
    sns_plot.figure.savefig("moqd.pdf", bbox_inches="tight", dpi=100)
